...
assert.match(fs.readFileSync(new URL('./geo-map.js', import.meta.url), 'utf8'), /geo\.segments/);
assert.match(fs.readFileSync(new URL('./geo-map.js', import.meta.url), 'utf8'), /geo\.markers/);
