...
test('maximum report navigation and 100-row label import stay within the document-wide element budget', async t => {
  ...
  assert.equal(document.querySelectorAll('*').length, 712, 'maximum valid report baseline including topology controls and fixed tooltip');
  ...
  assert.ok(document.querySelectorAll('*').length <= 712, 'reconstructed report remains no larger than the original mount');
